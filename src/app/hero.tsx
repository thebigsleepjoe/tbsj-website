  ...
  return (
    <div className="xl:-mt-16 -z-10 relative bg-gradient-to-r from-purple-600 to-blue-600 h-screen text-white overflow-hidden md:pb-32 pb-0">
      ...
      <div className="-mt-16 -z-10 absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-80% from-transparent to-gray-900 opacity-100"></div>
      </div>
      ...
      <div className="-mt-16 relative z-10 flex flex-col justify-center items-center h-full text-center">
        ...
        <p className="md:text-3xl text-sm text-gray-300 mb-2">
          Game Dev • Web Developer • Sysadmin
        </p>
        <div>
          <div className="flex flex-wrap md:gap-3 gap-2 md:max-w-2xl max-w-xs lg:mt-20 md:mt-16 mt-12 mb-12 md:mb-16 justify-center">
            <TagDark size="xl" color="purple">
              Lua
            </TagDark>
            <TagDark size="xl" color="green">
              Python
            </TagDark>
            <TagDark size="xl" color="yellow">
              JS/TS
            </TagDark>
            <TagDark size="xl" color="blue">
              Java
            </TagDark>
            <TagDark size="xl" color="pink">
              PowerShell
            </TagDark>
            <TagDark size="xl" color="indigo">
              Media
            </TagDark>
          </div>
          <div className="flex flex-wrap md:gap-2 gap-1 md:max-w-2xl max-w-xs justify-center">
            <TagDark size="lg" color="purple">
              Love2D
            </TagDark>
            <TagDark size="lg" color="purple">
              Modding
            </TagDark>
            <TagDark size="lg" color="green">
              AI
            </TagDark>
            <TagDark size="lg" color="green">
              ML
            ...
            <TagDark size="lg" color="blue">
              LWJGL
            </TagDark>
            <TagDark size="lg" color="indigo">
              Video Editing
            </TagDark>
            <TagDark size="lg" color="indigo">
              Image Editing
            </TagDark>
            <TagDark size="lg" color="gray">
              Git
            </TagDark>
            <TagDark size="lg" color="gray">
              GNU/Linux
