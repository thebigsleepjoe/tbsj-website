...
export function Hero() {
  return (
    ...
    <div className="-mt-16 relative z-10 flex flex-col justify-center items-center h-full text-center">
      <h1 className="text-9xl font-bold leading-tight mb-4">@thebigsleepjoe</h1>
      <p className="text-4xl text-gray-300 mb-2">{'$'} Software Engineer • Web Developer • IT Specialist</p>
      <div className="flex flex-wrap gap-3 max-w-2xl mt-32">
